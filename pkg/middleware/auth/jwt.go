...
// UserContextKey is the Gin context key for AuthenticatedUser set by JWTMiddleware.
...
func CurrentUser(c *gin.Context) *types.AuthenticatedUser {
	return c.MustGet(UserContextKey).(*types.AuthenticatedUser)
}
