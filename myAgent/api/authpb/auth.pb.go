...
const file_api_proto_auth_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken2\xa6\x03\n" +
	"\vAuthService\x12N\n" +
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponse\x12@\n" +
	"\bRegister\x12\x1c.auth.v1.RegisterUserRequest\x1a\x16.auth.v1.TokenResponse\x126\n" +
	"\x05Login\x12\x15.auth.v1.LoginRequest\x1a\x16.auth.v1.TokenResponse\x129\n" +
	"\x06Logout\x12\x16.auth.v1.LogoutRequest\x1a\x17.auth.v1.LogoutResponse\x12L\n" +
	"\x13HandleOAuthCallback\x12\x1d.auth.v1.OAuthCallbackRequest\x1a\x16.auth.v1.TokenResponse\x12D\n" +
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x16.auth.v1.TokenResponseB\x14Z\x12myAgent/api/authpbb\x06proto3"
...
var file_api_proto_auth_proto_depIdxs = []int32{
	...
	7, // 4: auth.v1.AuthService.HandleOAuthCallback:input_type -> auth.v1.OAuthCallbackRequest
	8, // 5: auth.v1.AuthService.RefreshToken:input_type -> auth.v1.RefreshTokenRequest
	1, // 6: auth.v1.AuthService.ValidateToken:output_type -> auth.v1.ValidateTokenResponse
	3, // 7: auth.v1.AuthService.Register:output_type -> auth.v1.TokenResponse
	3, // 8: auth.v1.AuthService.Login:output_type -> auth.v1.TokenResponse
	6, // 9: auth.v1.AuthService.Logout:output_type -> auth.v1.LogoutResponse
	3, // 10: auth.v1.AuthService.HandleOAuthCallback:output_type -> auth.v1.TokenResponse
	3, // 11: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.TokenResponse
