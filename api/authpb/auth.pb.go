...
const file_api_proto_auth_proto_rawDesc = "" +
	...
	"\x05state\x18\x03 \x01(\tR\x05state2\xe0\x02\n" +
	"\vAuthService\x12N\n" +
	...
	"\x13HandleOAuthCallback\x12\x1d.auth.v1.OAuthCallbackRequest\x1a\x16.auth.v1.TokenResponseB\x14Z\x12myAgent/api/authpbb\x06proto3"
...
var file_api_proto_auth_proto_depIdxs = []int32{
	...
	3, // 6: auth.v1.AuthService.Register:output_type -> auth.v1.TokenResponse
	3, // 7: auth.v1.AuthService.Login:output_type -> auth.v1.TokenResponse
	6, // 8: auth.v1.AuthService.Logout:output_type -> auth.v1.LogoutResponse
	3, // 9: auth.v1.AuthService.HandleOAuthCallback:output_type -> auth.v1.TokenResponse
